...
PERSONALIZED_NCF_MODEL_DIR = f'{os.environ.get("DATA_ROOT_DIR")}/ncf'
MOVIE_LENS_MOVIES_DATA = f'{os.environ.get("DATA_ROOT_DIR")}/movie_lens_movies.data'
MOVIE_LENS_RATINGS_DATA = f'{os.environ.get("DATA_ROOT_DIR")}/movie_lens_ratings.data'
MOVIE_ENCODER = f'{os.environ.get("DATA_ROOT_DIR")}/movie.encoder'
MOVIE_DECODER = f'{os.environ.get("DATA_ROOT_DIR")}/movie.decoder'
USER_ENCODER = f'{os.environ.get("DATA_ROOT_DIR")}/user.encoder'
